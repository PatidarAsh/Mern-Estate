...
import '../index.css'
// import HomeImage from '../images/image.jpg'
...
export default function Home() {
  ...
  return (
    ...
    <div className="">
      <div className="my-14 ml-14">
        <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl p-3'>Properties for you</h1>
        <p className='text-slate-700 font-bold text-sm lg:text-sm'>These properties are trending. Find the perfect place, book a tour, or contact to learn more.</p>
      </div>
    </div>
